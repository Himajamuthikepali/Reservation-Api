...
@RestController
@RequestMapping("/api")
public class MailSendingApiController {
	@Autowired
	...
	public String sendMail(@RequestParam String mailId, HttpServletRequest request) {
		...
		try {
			...
			helper.setText("Dear User, we are sending this mail to test our Mail Sending api,Please Ignore This Message"+activation_link);
